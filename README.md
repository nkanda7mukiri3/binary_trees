...
At the end of this project, We were able to understand:
...
39. Function that extracts the root node of a Max Binary Heap
40. Function that converts a Binary Max Heap to a sorted array of integers
